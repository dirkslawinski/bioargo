...
%
% OUTPUTS:
%   NO3 =   a matrix of nitrate concentrations (umol/L) and other infor
%       [SDN, DarkCur,Pres,Temp,Sal,NO3,BL_B,BL_M,RMS ERROR,WL~240,ABS~240]

% *************************************************************************
% TESTING
%cal_file  = 'C:\Users\jplant\Documents\MATLAB\ARGO\DATA\Cal_files\0508.cal';
%ncal      = parseNO3cal(cal_file);
%spec      = parse_NO3msg('C:\temp\0508.005.isus');
%Pcor_flag = 1;

% ************************************************************************
% CONSTANTS
% ************************************************************************
fig_flag = 0; %1; % 1 = show nitrate fit
